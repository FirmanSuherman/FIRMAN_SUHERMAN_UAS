...
function showDiv() {
    if(a === 0){
        ...
        document.querySelector('#backgpyro img').style.opacity ="0.4";
        function myFunction(x) {
          if (x.matches) { 
            document.querySelector('.container').style.display ="none";
            document.querySelector('#backgpyro').style.display = "none";
          } else {
           document.querySelector('#backgpyro').style.display = "block";
          }
        }
        ...
        document.querySelector('#backgpyro img').style.opacity ="0.3";
        function myFunction(x) {
          if (x.matches) { 
        ...
        .then(data1 => {
            if(data1.vision === "Pyro"){
                ...
                const renderCard = () =>{
                    ...
                    document.querySelector('.desc').style.border="5px solid #ff0000";
    ...
    if(b === 0){
        ...
        for(let i=0; i<charHover.length; i++){  
            charHover[i].addEventListener('mouseover', () => {     
                charHover[i].style.background = '#ff9494';
            });
        ...
        for(let i=0; i<charHover.length; i++){  
            charHover[i].addEventListener('mouseover', () => {     
                charHover[i].style.background = '#530000';
            });
            charHover[i].addEventListener('mouseout', () => {
                charHover[i].style.background = 'none';
            });
...
function moveDivRight(){
    if(c===0){
        document.querySelector('.photo-1').src="/image/pyro-swirl.png";
        ...
        document.querySelector('#rec p').textContent="Burn";
        c=3;
    }else if(c===3){
